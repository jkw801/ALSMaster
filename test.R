...
# 이 아래는 콕스
coxph.training=coxph(Surv(movement_whenevent,movement_isevent==1)~Onsetsite+Sex+log(-Onset_Delta)+log(-Diagnosis_Delta+10)+weight_min+q1_min+q2_min+q3_min+q4_min+q6_min
                     +q7_min+q8_min+q9_min,data=mergetraining)
...
# 이 아래는 weibull
weibull.training=survreg(Surv(movement_whenevent,movement_isevent==1)~Onsetsite+Sex+log(-Onset_Delta)+log(-Diagnosis_Delta+10)+weight_min+q1_min+q2_min+q3_min+q4_min+q6_min
                         +q7_min+q8_min+q9_min,data=mergetraining,dist="weibull")
...
# 이 아래는 lognormal
lognormal.training=survreg(Surv(movement_whenevent,movement_isevent==1)~Onsetsite+Sex+log(-Onset_Delta)+log(-Diagnosis_Delta+10)+weight_min+q1_min+q2_min+q3_min+q4_min+q6_min
                           +q7_min+q8_min+q9_min,data=mergetraining,dist="lognormal")
...
# 이 아래는 randomforest.
rf=rfsrc(Surv(movement_whenevent,movement_isevent==1)~Onsetsite+Sex+log(-Onset_Delta)+log(-Diagnosis_Delta+10)+weight_min+q1_min+q2_min+q3_min+q4_min+q6_min
         +q7_min+q8_min+q9_min,data=mergetraining)
...
lines(predict(weibull.training,newdata=mergetest[25,],type="quantile",p=seq(.01,.99,by=.01)),seq(.99,.01,by=-.01),col="red",type="l",lwd=1)
...
lines(pred$time.interest,pred$survival[25,],type="l",col="green",ylim=c(0,1))
